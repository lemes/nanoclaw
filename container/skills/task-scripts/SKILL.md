...
For recurring tasks, use `ncl tasks create --script` — the script runs first, and the agent is only called when the check passes. This keeps API credit usage to a minimum.
